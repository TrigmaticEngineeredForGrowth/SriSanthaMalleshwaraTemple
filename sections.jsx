        ...
        <div className="grid-footer" style={{ marginBottom: 80 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 22, display: 'flex', gap: 14, alignItems: 'center' }}>
              {/* WhatsApp */}
              <a href="#" title="WhatsApp" style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid var(--line)', display: 'grid', placeItems: 'center', color: 'var(--ivory-dim)', transition: 'all .3s ease', textDecoration: 'none' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; e.currentTarget.style.background = 'rgba(255,122,46,0.08)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--line)'; e.currentTarget.style.color = 'var(--ivory-dim)'; e.currentTarget.style.background = 'transparent'; }}>
              ...
              {/* Instagram */}
              <a href="#" title="Instagram" style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid var(--line)', display: 'grid', placeItems: 'center', color: 'var(--ivory-dim)', transition: 'all .3s ease', textDecoration: 'none' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; e.currentTarget.style.background = 'rgba(255,122,46,0.08)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--line)'; e.currentTarget.style.color = 'var(--ivory-dim)'; e.currentTarget.style.background = 'transparent'; }}>
              ...
              {/* Email */}
              <a href="#" title="Email" style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid var(--line)', display: 'grid', placeItems: 'center', color: 'var(--ivory-dim)', transition: 'all .3s ease', textDecoration: 'none' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; e.currentTarget.style.background = 'rgba(255,122,46,0.08)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--line)'; e.currentTarget.style.color = 'var(--ivory-dim)'; e.currentTarget.style.background = 'transparent'; }}>
              ...
              {/* YouTube */}
              <a href="#" title="YouTube" style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid var(--line)', display: 'grid', placeItems: 'center', color: 'var(--ivory-dim)', transition: 'all .3s ease', textDecoration: 'none' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; e.currentTarget.style.background = 'rgba(255,122,46,0.08)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--line)'; e.currentTarget.style.color = 'var(--ivory-dim)'; e.currentTarget.style.background = 'transparent'; }}>
