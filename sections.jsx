      ...
      <div className="container">
        <div className="grid-footer" style={{ marginBottom: 80 }}>
          <div>
            ...
            <p style={{ marginTop: 20, fontFamily: 'var(--f-mono)', fontSize: 11, color: 'var(--ivory-faint)', letterSpacing: '0.14em', display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 22, display: 'flex', gap: 14, alignItems: 'center' }}>
              ...
              {/* Email */}
              <a href="mailto:santhamalleswara@gmail.com" title="Email" style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid var(--line)', display: 'grid', placeItems: 'center', color: '#EA4335', transition: 'all .3s ease', textDecoration: 'none' }}
